...
\begin{figure}[htbp] 
    ...
    \caption{Distribution of images available in the dataset for each of the five facilities. The numbers indicate hoow many images are available in the indicated month.}\label{fig:heatmap} 
\end{figure}
