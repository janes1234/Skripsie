...
% Figures
\usepackage[margin=\parindent, font=small, labelfont=bf, textfont=rm]{caption}
\usepackage{pdfpages}
...
\usepackage{environ}
\usepackage{tikz}
\usetikzlibrary{fit,backgrounds,calc,shapes.geometric,arrows.meta,positioning}
% Pseudo-code
